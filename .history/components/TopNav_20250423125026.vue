<template>
  <div class="flex flex-row-reverse justify-between items-center p-4 border-b" dir="rtl">
    ...
    <div class="flex items-center">
      <img src="https://life.jabama.org/wp-content/uploads/2024/04/لوگو.png" alt="Jabama Logo" class="h-10">
    </div>
  </div>
</template>
