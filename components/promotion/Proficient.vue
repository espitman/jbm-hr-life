<template>
  <div class="flex flex-col md:flex-row items-center justify-between w-full bg-white rounded-xl px-0 py-8 md:px-8 gap-8">
    <!-- Farsi Text -->
    ...
    <div class="flex-1 flex justify-center">
      <img src="/images/promotion/proficient.jpg" alt="IC/ Proficientمسیر" class="max-w-xs md:max-w-sm w-1/2 h-auto rounded-lg" />
    </div>
  </div>
</template>
