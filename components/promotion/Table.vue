<template>
  <div class="overflow-x-auto w-full bg-white rounded-xl p-4" dir="rtl">
    <table class="min-w-[900px] w-full border-collapse">
      <thead>
        <tr class="bg-gray-100">
          <th class="py-3 px-2 font-bold text-orange-500 border border-gray-300 text-center align-middle" rowspan="2">کمیته+مدیر ارشد+HRBP</th>
          <th class="py-3 px-2 font-bold border border-gray-300 text-center align-middle" rowspan="2">مدت زمان حضور</th>
          <th class="py-3 px-2 font-bold border border-gray-300 text-center align-middle" rowspan="2">تعداد سیکل<br/><span class='text-xs'>(نمره=3 Above)</span></th>
          <th class="py-3 px-2 font-bold border border-gray-300 text-center align-middle" colspan="3">ارزیابی شایستگی</th>
          <th class="py-3 px-2 font-bold border border-gray-300 text-center align-middle" rowspan="2">رده مقصد</th>
          <th class="py-3 px-2 font-bold border border-gray-300 text-center align-middle" rowspan="2">رده مبدا</th>
        </tr>
        <tr class="bg-gray-100">
          <th class="py-3 px-2 font-bold border border-gray-300 text-center align-middle w-24">فیدبک 360</th>
          <th class="py-3 px-2 font-bold border border-gray-300 text-center align-middle w-24">مصاحبه</th>
          <th class="py-3 px-2 font-bold border border-gray-300 text-center align-middle w-24">ارزیابی فنی</th>
        </tr>
      </thead>
      <tbody class="text-gray-700">
        <tr class="even:bg-gray-50">
          ...
          <td class="py-3 px-2 border border-gray-300 text-center align-middle">کارآموز<br/><span class="text-xs text-gray-500">Intern</span></td>
        </tr>
        <tr class="even:bg-gray-50">
          <td class="py-3 px-2 border border-gray-300 text-center align-middle">HRBP + مدیر ارشد</td>
          <td class="py-3 px-2 border border-gray-300 text-center align-middle">6 ماه</td>
...
/* Make the three columns under ارزیابی شایستگی equal width */
th:nth-child(4),
th:nth-child(5),
th:nth-child(6),
td:nth-child(4),
